...
public class RandomObjectGenerator {
    ...
    private boolean isWrappedPrimitive(Class<?> parameterType) {
        return parameterType == Boolean.class || parameterType == Character.class || parameterType == Byte.class ||
            parameterType == Short.class || parameterType == Integer.class || parameterType == Long.class ||
    ...
    private Object[] generateParameters(Parameter[] parameters) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            if (parameterType.isPrimitive()) {
                ...
                args[i] =
                    PrimitiveAndWrappedTypesGenerator.generateWrappedPrimitive(parameterAnnotations, parameterType);
            } else {
